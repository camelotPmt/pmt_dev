...
public class ApiResponse {
     ...
     * @param status
     *            required APIStatus
     * @return {"status":{"code":xxx,"message":"xxx"}} @author[tongxiying]
     */
     ...
     * 
     * <p>
     * Discription:[获取请求处理成功返回结果]
     * </p>
     * 
     * @return {"status":{"code":200,"message":"ok"}} @author[tongxiying]
     */
