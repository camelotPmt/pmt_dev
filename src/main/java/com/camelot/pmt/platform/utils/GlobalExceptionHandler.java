...
import com.camelot.pmt.platform.common.SrfException;
...
public class GlobalExceptionHandler {
    ...
    public JSONObject unknownAccountException(Exception e) {
        return com.camelot.pmt.platform.common.ApiResponse.jsonData(com.camelot.pmt.platform.common.APIStatus.NOT_USERNAME_404);
    }
